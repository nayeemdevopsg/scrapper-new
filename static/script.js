...
fetch("http://3.104.27.245/v1/scraper/number_of_ads")
...
fetch("http://3.104.27.245/v1/scraper/ad_queries_count")
.then(response => response.json())
.then(data => {
  // Update the HTML with the retrieved data
...
form.addEventListener("submit", event => {
    ...
    const url = `http://3.104.27.245/v1/scraper/${query}`;
...
document.getElementById('searchForm').addEventListener('submit', function(e) {
  ...
  fetch('http://3.104.27.245/v1/scraper/', {
    method: 'POST',
    headers: {
